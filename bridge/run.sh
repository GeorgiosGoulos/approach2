...
if mpic++ -pthread -std=c++11  -DBRIDGE  -DEVALUATE -DVERBOSE -DTHREADED_SEND -DMPI_TOPOLOGY_OPT -Wall -Werror main.cc System.cc Tile.cc Transceiver.cc Packet.cc Bridge.cc; then		# COMPILATION
